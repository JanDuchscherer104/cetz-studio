...
with sync_playwright() as runtime:
    ...
    page.add_script_tag(path=str(ROOT / "web/dist/svg.js"))
    results = page.evaluate(r"""() => {
      ...
      function clean(body, attrs = '') {
        ...
        return CetzSvg.sanitizeSvg(root);
      }
      ...
      let refused = false; try { CetzSvg.sanitizeSvg(document.createElement('div')); } catch { refused = true; }
