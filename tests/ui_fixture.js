...
(() => {
  ...
  function render(){
    const S=72/25.4;
    let svg=`<svg xmlns="http://www.w3.org/2000/svg" width="520pt" height="405pt" viewBox="0 0 520 405"><rect width="520" height="405" fill="white"/><text x="260" y="24" text-anchor="middle" fill="#26374b" font-family="Georgia,serif" font-weight="bold" font-size="13">Candidate scoring · layout fixture</text><g transform="translate(24 45) scale(${S})">`;
